package com.mikey.msosle.dao.admin.impl;

import com.mikey.msosle.dao.admin.AdminDao;
...
public class AdminDaoImpl implements AdminDao {
    ...
    public List<SysAdminEntity> findAllAdmin(SysAdminEntity sysAdminEntity) {
        return (List<SysAdminEntity>) hibernateTemplate.find("from com.mikey.youngvolunteer.model.SysAdminEntity");
    }
